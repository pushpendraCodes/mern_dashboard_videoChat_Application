        ...
        <div className="modal-dialog relative w-auto pointer-events-none">
          <div
            ...
            <div
              ...
              <h5 style={{ color: 'rgb(229, 57, 53)' }} className="text-xl  leading-normal  block uppercase tracking-wide text-gray-700 text-xs font-bold " id="exampleModalLabel">Clients Details</h5>
              <button type="button"
